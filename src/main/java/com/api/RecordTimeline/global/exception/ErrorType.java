...
public enum ErrorType {
    ...
    // ------------------------------------------ LOGIN ------------------------------------------
    _APP_LOGIN_FAIL(OK, "LOGIN4000", "로그인에 실패했습니다."),
    _PASSWORD_MISMATCH(OK,"LOGIN4001" ,"비밀번호가 일치하지 않습니다." ),

    // ------------------------------------------ SIGNUP ------------------------------------------
    _DUPLICATE_NICKNAME(OK,"SIGNUP4000", "중복된 닉네임입니다."),
    _DUPLICATE_EMAIL(OK,"SIGNUP4001" , "중복된 이메일입니다."),
    CERTIFICATION_FAILED(OK,"SIGNUP4002" , "검증에 실패했습니다." ),
    INVALID_PASSWORD_PATTERN(OK, "SIGNUP4003","비밀번호 형식이 일치하지 않습니다." ),


    MAIL_SEND_FAIL(OK, "MAIL4000","메일 전송에 실패했습니다." );
